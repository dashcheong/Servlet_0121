...
<div class="container ">
	<form method ="post" action="/jsp/test05_2.jsp">
		...
		<div class="">
		<div class="d-flex">
		<input type ="text" class="form-control"  name="length" style ="width:200px">cm
		</div>
		
		<label>인치<input type = "checkbox" name="type" value="inch"></label>
		<label>야드	<input type = "checkbox" name="type" value="yard"></label>
		<label>피트</label><input type = "checkbox" name="type" value="feet"></label>
		<label>미터</label><input type = "checkbox" name="type" value="meter"></label><br>
